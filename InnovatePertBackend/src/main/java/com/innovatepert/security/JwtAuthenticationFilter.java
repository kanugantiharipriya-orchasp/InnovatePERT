...
//
//                // Clean role string (e.g., ADMIN)
//                String rawRole = (role != null) ? role.trim().toUpperCase() : "ADMIN";
//
//                List<SimpleGrantedAuthority> authorities = List.of(
//                        new SimpleGrantedAuthority(rawRole),
//                        new SimpleGrantedAuthority("ROLE_" + rawRole.replace("ROLE_", ""))
//                );
//
//                // Create UserDetails with Dynamic Authorities using explicit Spring Security User class
...
//                                    userDetails,
//                                    null,
//                                    authorities); // Direct Authorities Injection
//
...
//
//                    System.out.println("✅ JWT SUCCESS: Authenticated User [" + email + "] with Role [" + rawRole + "]");
//                }
//            }
//
//        } catch (Exception e) {
